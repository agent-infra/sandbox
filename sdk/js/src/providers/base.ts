...
export type SandboxResponse = any;
...
export abstract class BaseProvider {
     ...
     */
    abstract createSandbox(functionId: string, kwargs?: Record<string, any>): Promise<SandboxResponse>;
     ...
     */
    abstract deleteSandbox(functionId: string, sandboxId: string, kwargs?: Record<string, any>): Promise<SandboxResponse>;
     ...
     */
    abstract getSandbox(functionId: string, sandboxId: string, kwargs?: Record<string, any>): Promise<SandboxResponse>;
     ...
     */
    abstract listSandboxes(functionId: string, kwargs?: Record<string, any>): Promise<SandboxResponse>;
}
